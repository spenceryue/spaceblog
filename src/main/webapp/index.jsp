...
%>
	...
	<a href="create.jsp" id="create" class="text-gradient">
		Create a new planet
		<div id="plus">+</div>
	</a>
	</aside>
...
<%
	...
	List<Planet> planets = ObjectifyService.ofy().load().type(Planet.class).ancestor(GalaxyKey).limit(5).order("-date").list();
%>
	<ul>
<%
	int i=1;
...
%>
		<a href="map.jsp" id="map"><div class="opt">galaxy map</div></a>
