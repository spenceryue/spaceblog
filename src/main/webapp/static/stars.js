...
function initStars() {
	...
	if (canvas === undefined || canvas == null || typeof Delaunay === 'undefined') {
...
function loadStars() {
    var script, 
        add = function(url, id) {
        	...
        	script.src = url;
        	script.async = 'true';
        	script.onload = initStars();
        	document.head.appendChild(script);
        }

    // Delaunay Triangulation
    // add('delaunay.js', 'delaunay');
    add('https://rawgit.com/ironwallaby/delaunay/master/delaunay.js', 'delaunay');
}
